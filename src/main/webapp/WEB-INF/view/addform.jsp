...
<link type="text/css" rel="stylesheet"
	href="../resources/css/angular-form-builder.css">
...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="container">
		...
		<div class="col-md-6">
			<input ng-model="nameform" type="text" class="form-control col-md-4"
	...
	<div class="container">
		...
		<div class="col-md-3"></div>
		<div class="col-md-6">
			<select class="form-control col-md-6" ng-model="userform"
