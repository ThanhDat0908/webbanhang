...
<ul class="breadcrumb">
  <li class="firstItem"><a href="https://tm-shopify090-mobile.myshopify.com/" class="homepage-link" title="Back to the frontpage">Home</a></li>
  
      <li class="lastItem"><span class="page-title">Create Account</span></li>
...
<div id="template" class="customer customer__register">
  <div id="customer">
      ...
      <div class="form-horizontal">    
              <form method="post" action="https://tm-shopify090-mobile.myshopify.com/account" id="create_customer" accept-charset="UTF-8"><input value="create_customer" name="form_type" type="hidden"><input name="utf8" value="✓" type="hidden">
                
        
                <div class="clearfix form-group">
                  <label for="first_name" class="login control-label col-sm-4">Account</label>
                  <div class="col-sm-4"><input class="form-control" size="30" type="text"></div>
                </div>
        
                <div class="clearfix form-group">
                  <label for="last_name" class="login control-label col-sm-4">Email</label>
                  <div class="col-sm-4"><input id="last_name" class="form-control" size="30" type="email"></div>
                </div>
        
                <div class="clearfix form-group">
                  <label for="email" class="login control-label col-sm-4">Birthday</label>
                  <div class="col-sm-4"><input class="form-control" size="30" type="date"></div>
                </div>
        
                <div id="password" class="clearfix form-group">
                  <label for="password" class="login control-label col-sm-4">Password</label>
                  <div class="col-sm-4"><input class="form-control password" size="30" type="password"></div>
                </div>
        
                <div class="form-group">
                  <div class="col-sm-offset-4 col-sm-4">
                    <input class="btn btn-primary" value="Create" type="submit">
                    <span class="note">or <a href="https://tm-shopify090-mobile.myshopify.com/">Return to Store</a></span>
                  </div>
                </div>
              </form>
      </div>
